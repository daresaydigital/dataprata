...
export const IosIcon: React.FC<IconProps> = ({ color = "#333", width = "80", height = "48" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none" viewBox="0 0 80 48">
    ...
    />
    <rect width="2" height="4" x="13" y="8" fill={color} rx="1" />
    <rect width="2" height="4" x="13" y="14" fill={color} rx="1" />
    <path fill={color} d="M16 42H49V46H16z" />
...
export const AndroidIcon: React.FC<IconProps> = ({ color = "#333", width = "80", height = "48" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none" viewBox="0 0 80 48">
    ...
    />
    <rect width="2" height="6" x="49" y="6" fill={color} rx="1" />
    <path fill={color} d="M15 44H48V46H15z" />
    <path fill={color} d="M15 2H48V4H15z" />
    <path
      fill={colors.black}
